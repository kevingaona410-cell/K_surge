...
#La clase lugar contiene la informacion que solicitamos de la API
class Lugar:
    ...
    def __init__(self, lugar_api, categoria, detalles):
        ...
        self.rating = lugar_api.get("rating", 0)                    #Calificacion (segun google.places (maps))

        self.telefono = detalles.get("formatted_phone_number", "")  #Numero de telefono 
